...
vim.keymap.set('n', '<leader>flg', telescope_live_grep_open_files, { desc = 'Live grep' })
...
vim.keymap.set('n', '<leader>sgg', ':LiveGrepGitRoot<cr>', { desc = 'Search by Grep on Git Root' })
